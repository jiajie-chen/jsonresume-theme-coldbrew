...
import { formatAddress as formatAddressByCountry, loadCountries } from '@shopify/address'
 ...
 * @returns 
 */
export function formatAddress(address: string, city: string, region: string, postalCode: string, countryCode: string, localeCountries: Country[]): string[] {
 ...
 * @returns 
 */
export async function loadCountryFormatters(locale: string): Promise<Country[]> {
